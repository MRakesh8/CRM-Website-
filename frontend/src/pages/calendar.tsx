...
export default function Calendar() {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="flex items-center justify-between bg-card p-4 rounded-t-xl border border-b-0">
      ...
      <div className="border rounded-b-xl bg-card shadow-sm overflow-hidden">
        {/* Days Header */}
