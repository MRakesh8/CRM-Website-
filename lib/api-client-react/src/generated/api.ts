...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateRoleMutationBody = BodyType<RoleInput> | undefined
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateRoleMutationBody = BodyType<RoleInput> | undefined
...
export const listPermissions = async ( options?: RequestInit): Promise<ListPermissions200> => {
  ...
  return customFetch<ListPermissions200>(getListPermissionsUrl(),
  {
    ...options,
    method: 'GET'
